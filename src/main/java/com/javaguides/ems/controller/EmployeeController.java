...
//for to handle http reuest
@CrossOrigin("*")
@RestController
//for to base url for all rest apis
...
public class EmployeeController {
	...
	//add employee restapi
	    ...
	    /*URI template variable ante:

REST API URL lo curly braces {} lo declare chesina placeholder variable.
Idhi client nunchi path lo pass chestam.*/
	    @DeleteMapping("{id}")
